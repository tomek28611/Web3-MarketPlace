              ...
              {listings?.map((listing) => (
                <div className="flex flex-col card hover:scale-105 transition-all duration-150 ease-out" key={listing.id} >
                  ...
                  <div className="pt-2 space-y-4">
                    ...
                    <div className={`flex items-center space-x-1 justify-end border w-fit
                    ml-auto p-2 rounded-lg text-white ${listing.type === ListingType.Direct ? "bg-blue-500" : "bg-red-500"}`}>
                      <p>
